...
func NewEASServer(
	...
	return &EASServer{
		...
		vpcEndpointStats: storage.NewVPCEndpointStatisticsStorage(nsxClient, k8sClient, vpcProvider),
		vpcServiceEndpointStats: storage.NewVPCServiceEndpointStatisticsStorage(nsxClient, k8sClient, vpcProvider),
